...
from .enums import ChannelType, ContentFilter, Status, VerificationLevel, VoiceRegion
...
class Guild(Hashable):
    ...
    def create_category(
        self, name: str, *, overwrites: Optional[Any] = ..., reason: Optional[Any] = ...
    ): ...
    ...
    def invites(self): ...
    def create_custom_emoji(self, name: str, image: Any, *, reason: Optional[Any] = ...): ...
    def create_role(self, *, reason: Optional[Any] = ..., **fields: Any): ...
    def kick(self, user: Any, *, reason: Optional[Any] = ...) -> None: ...
    def ban(
        self, user: Any, *, reason: Optional[Any] = ..., delete_message_days: int = ...
    ) -> None: ...
