# Stubs for discord.ext.commands.core (Python 3.6)
#
...
class Command:
    ...
    instance: Any = ...
    parent: Any = ...
    def __init__(self, name: Any, callback: Any, **kwargs: Any) -> None: ...
...
class GroupMixin:
    ...
    def remove_command(self, name: Any): ...
    def walk_commands(self) -> None: ...
    def get_command(self, name: Any): ...
