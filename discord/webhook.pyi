...
class WebhookAdapter:
    BASE: str = ...
    def request(self, verb: Any, url: Any, payload: Optional[Any] = ..., multipart: Optional[Any] = ...) -> None: ...
    def delete_webhook(self): ...
    def edit_webhook(self, **payload: Any): ...
    def handle_execution_response(self, data: Any, wait: Any) -> None: ...
    def execute_webhook(self, payload: Any, *, wait: bool = ..., file: Optional[Any] = ...): ...

class AsyncWebhookAdapter(WebhookAdapter):
    session: Any = ...
    loop: Any = ...
    def __init__(self, session: Any) -> None: ...
    def request(self, verb: Any, url: Any, payload: Optional[Any] = ..., multipart: Optional[Any] = ...): ...
...
class Webhook:
    ...
    token: Any = ...
    user: Any = ...
    def __init__(self, data: Any, adapter: Any, *, state: Optional[Any] = ...) -> None: ...
    @property
    def url(self): ...
    @classmethod
    ...
    def send(self, content: Optional[Any] = ..., *, wait: bool = ..., username: Optional[Any] = ..., avatar_url: Optional[Any] = ..., tts: bool = ..., file: Optional[Any] = ..., embed: Optional[Any] = ..., embeds: Optional[Any] = ...): ...
