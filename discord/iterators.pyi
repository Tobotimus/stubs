...
class ReactionIterator(_AsyncIterator):
    ...
    channel_id: Any = ...
    users: Any = ...
    def __init__(self, message: Any, emoji: Any, limit: int = ..., after: Optional[Any] = ...) -> None: ...
    def next(self): ...
...
class HistoryIterator(_AsyncIterator):
    ...
    logs_from: Any = ...
    messages: Any = ...
    def __init__(self, messageable: Any, limit: Any, before: Optional[Any] = ..., after: Optional[Any] = ..., around: Optional[Any] = ..., reverse: Optional[Any] = ...) -> None: ...
    def next(self): ...
    channel: Any = ...
    def flatten(self): ...
...
class AuditLogIterator(_AsyncIterator):
    ...
    reverse: Any = ...
    entries: Any = ...
    def __init__(self, guild: Any, limit: Optional[Any] = ..., before: Optional[Any] = ..., after: Optional[Any] = ..., reverse: Optional[Any] = ..., user_id: Optional[Any] = ..., action_type: Optional[Any] = ...) -> None: ...
    def next(self): ...
