...
from .core import Command, GroupMixin, command
...
class BotBase(GroupMixin):
    ...
    help_attrs: Any = ...
    formatter: Any = ...
    def __init__(self, command_prefix: Any, formatter: Optional[Any] = ..., description: Optional[Any] = ..., pm_help: bool = ..., **options: Any) -> None: ...
    ...
    def get_cog(self, name: Any): ...
    def get_cog_commands(self, name: Any): ...
    def remove_cog(self, name: Any): ...
    def load_extension(self, name: Any): ...
    def unload_extension(self, name: Any): ...
