...
class HTTPClient:
    ...
    def request(
        self, route: Any, *, header_bypass_delay: Optional[Any] = ..., **kwargs: Any
    ): ...
    ...
    def delete_message(
        self, channel_id: Any, message_id: Any, *, reason: Optional[Any] = ...
    ): ...
    def delete_messages(
        self, channel_id: Any, message_ids: Any, *, reason: Optional[Any] = ...
    ): ...
    ...
    def remove_reaction(
        self, message_id: Any, channel_id: Any, emoji: Any, member_id: Any
    ): ...
    ...
    def edit_profile(
        self, password: Any, username: Any, avatar: Any, **fields: Any
    ): ...
    def change_my_nickname(
        self, guild_id: Any, nickname: Any, *, reason: Optional[Any] = ...
    ): ...
    def change_nickname(
        self, guild_id: Any, user_id: Any, nickname: Any, *, reason: Optional[Any] = ...
    ): ...
    def edit_member(
        self, guild_id: Any, user_id: Any, *, reason: Optional[Any] = ..., **fields: Any
    ): ...
    def edit_channel(
        self, channel_id: Any, *, reason: Optional[Any] = ..., **options: Any
    ): ...
    def bulk_channel_update(
        self, guild_id: Any, data: Any, *, reason: Optional[Any] = ...
    ): ...
    def create_channel(
        self,
        guild_id: Any,
        ...
        permission_overwrites: Optional[Any] = ...,
        *,
        reason: Optional[Any] = ...
    ): ...
    def delete_channel(self, channel_id: Any, *, reason: Optional[Any] = ...): ...
    def create_webhook(
        self, channel_id: Any, *, name: Optional[Any] = ..., avatar: Optional[Any] = ...
    ): ...
    ...
    def create_guild(self, name: str, region: Any, icon: Any): ...
    def edit_guild(
        self, guild_id: Any, *, reason: Optional[Any] = ..., **fields: Any
    ): ...
    ...
    def change_vanity_code(
        self, guild_id: Any, code: Any, *, reason: Optional[Any] = ...
    ): ...
    def prune_members(
        self, guild_id: Any, days: Any, *, reason: Optional[Any] = ...
    ): ...
    def estimate_pruned_members(self, guild_id: Any, days: Any): ...
    def create_custom_emoji(
        self, guild_id: Any, name: str, image: Any, *, reason: Optional[Any] = ...
    ): ...
    def delete_custom_emoji(
        self, guild_id: Any, emoji_id: Any, *, reason: Optional[Any] = ...
    ): ...
    def edit_custom_emoji(
        self, guild_id: Any, emoji_id: Any, name: str, *, reason: Optional[Any] = ...
    ): ...
    def get_audit_logs(
        self,
        guild_id: Any,
    ...
    def edit_role(
        self, guild_id: Any, role_id: Any, *, reason: Optional[Any] = ..., **fields: Any
    ): ...
    def delete_role(
        self, guild_id: Any, role_id: Any, *, reason: Optional[Any] = ...
    ): ...
    def replace_roles(
        self, user_id: Any, guild_id: Any, role_ids: Any, *, reason: Optional[Any] = ...
    ): ...
    def create_role(
        self, guild_id: Any, *, reason: Optional[Any] = ..., **fields: Any
    ): ...
    def move_role_position(
        self, guild_id: Any, positions: Any, *, reason: Optional[Any] = ...
    ): ...
    def add_role(
        self, guild_id: Any, user_id: Any, role_id: Any, *, reason: Optional[Any] = ...
    ): ...
    def remove_role(
        self, guild_id: Any, user_id: Any, role_id: Any, *, reason: Optional[Any] = ...
    ): ...
    ...
    def delete_channel_permissions(
        self, channel_id: Any, target: Any, *, reason: Optional[Any] = ...
    ): ...
    def move_member(
        self,
        user_id: Any,
